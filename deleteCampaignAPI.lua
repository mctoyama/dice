...
local DeleteCampaignAPI = {}

----------------------------------------------------------------------------------
function DeleteCampaignAPI.post()
   ...
   ok = campaignMod.delete(session:get("accountId"),args["campaignId"])

   ngx.say(cjson.encode{ok=ok})
